...
e' :: Text
e' = "(context[_evolution-context] < 0) impl (feature[_a63857d6-2617-4a9d-911d-1f59aa423d49] = 1)"

f' :: Text
f' = "context[_evolution-context] < 0 impl"

autoToVSat :: Show a => AutoLang a -> V.VProp String String
autoToVSat (AutoLit a) = V.LitB a
autoToVSat (Ctx op a b) = V.ChcB "AA" (autoToVSat b) (V.LitB True)
autoToVSat (AutoRef a) = V.RefB (show a)
...
autoToVSat' :: Show a => ALang a -> V.VIExpr String
autoToVSat' (ALit i) = V.LitI $ V.I i
autoToVSat' (AVar a) = V.Ref V.RefI $ show a
